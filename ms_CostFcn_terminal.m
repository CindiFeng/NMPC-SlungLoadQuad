...
qpos = Xq; % only position at last time step is used
cnav = (norm(qGoal-qpos))^2/(norm(qGoal-qStart))^2; % navigation cost term
wnav = 1; % weight
...
cost = wnav*cnav + win*cin + wswing*cswing + wpf.'*cpf;
